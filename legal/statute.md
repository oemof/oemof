...
It is not legally binding but just provided for your convenience. 


## General Definitions

1.  The association is called "oemof".
    It shall be registred with the German authorities.
    Afterwards, the status will be signified by expanding the name to "oemof e.V.".
2.  Its headquarters is in Berlin.
3.  Its fiscal year is the calendar year.


## Goals

1. The association pursues exclusively non-profit goals as specified in the paragraph "Tax-deductible purposes" of the tax code.
2. The goal of the association is the promotion of science and research.
    This goal is followed, i.e. by
    1. providing scientific software,
         especially software which is part of the "Open Energy Modelling Framework",
         under free and open source licenses as defined by the "Open Source Initiative" and by
    2. supporting development, maintanence, usage and documentation of that software.


## Non-Profit Status

1. The foundation is not-for-profit. It does not pursue its own economic purposes as a primary goal.
2. The resources of the foundation may only be used for the purposes set forth in its Articles of Association.
    Members of the association may receive neither a share of the associations profit nor other payments for being a member.
3. Nobody may benefit from expenditures, that do not help fulfilling the goals of the association, or by unproportianal payments.
